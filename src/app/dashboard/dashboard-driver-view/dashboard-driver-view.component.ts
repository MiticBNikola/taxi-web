...
@Component({
  selector: 'app-dashboard-driver-view',
  templateUrl: './dashboard-driver-view.component.html',
  styleUrls: ['./dashboard-driver-view.component.css']
})
export class DashboardDriverViewComponent implements OnInit {
